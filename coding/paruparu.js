...
document.addEventListener("DOMContentLoaded", () => {
  const start = async () => {
    try {
      ...
      infoText.innerText = "PARU-PARU - Tempat pertukaran gas 🫁";
      ...
      const mindarThree = new window.MINDAR.IMAGE.MindARThree({
        ...
        imageTargetSrc: "/FYP/assets/targets/paruparu.mind"
      });
      ...
      const model = await new Promise((res, rej) => {
        loader.load("/FYP/assets/models/paruparu.glb", res, null, rej);
      });
      ...
      narration.setBuffer(await loadAudio("/FYP/assets/sounds/paruparu.mp4"));
	...
	//screen tap and when model shown
      ...
      breathing.setBuffer(await loadAudio("/FYP/assets/sounds/ParuBernafas.mp4"));
