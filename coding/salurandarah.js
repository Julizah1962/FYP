...
document.addEventListener("DOMContentLoaded", () => {
  const start = async () => {
    try {
      ...
      infoText.innerText = "SALURAN DARAH - Berperanan sebagai tiub untuk menyalurkan sel darah ke seluruh badan🎈";
      ...
      const mindarThree = new window.MINDAR.IMAGE.MindARThree({
        ...
        imageTargetSrc: "/FYP/assets/targets/salurandarah.mind"
      });
      ...
      const model = await new Promise((res, rej) => {
        loader.load("/FYP/assets/models/salurandarah.glb", res, null, rej);
      });
      ...
      narration.setBuffer(await loadAudio("/FYP/assets/sounds/salurandarah.mp4"));
