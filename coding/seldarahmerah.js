...
document.addEventListener("DOMContentLoaded", () => {
  const start = async () => {
    try {
      ...
      infoText.innerText = "SEL DARAH MERAH - mengangkut oksigen ke seluruh badan 🎈";
      ...
      const model = await new Promise((res, rej) => {
        loader.load("/FYP/assets/models/seldarahmerah.glb", res, null, rej);
      });
      ...
      narration.setBuffer(await loadAudio("/FYP/assets/sounds/seldarahmerah.mp4"));
